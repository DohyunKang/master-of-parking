    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('{}#answer_{}'.format(
                resolve_url('posts:detail', question_id=question.id), answer.id))
    else:
...
def answer_modify(request, answer_id):
    ...
    if request.user != answer.author:
        messages.error(request, '수정권한이 없습니다')
        return redirect('posts:detail', question_id=answer.question.id)
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            answer.save()
            return redirect('{}#answer_{}'.format(
                resolve_url('posts:detail', question_id=answer.question.id), answer.id))
    else:
...
def comment_create_answer(request, answer_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            comment.save()
            return redirect('posts:detail', question_id=comment.answer.question.id)
    else:
        form = CommentForm()
    context = {'form': form}
...
def comment_modify_answer(request, comment_id):
    ...
    context = {'form': form}
    return render(request, 'posts/comment_modify_form.html', context)
